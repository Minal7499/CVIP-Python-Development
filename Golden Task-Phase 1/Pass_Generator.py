...
# Title Label
title_label = tk.Label(window, text="Password Generator", font=("Arial", 24, "bold"), bg="#f5f5f5", fg="#333")
title_label.pack(pady=20)

# Labels and Entry for password length
length_label = tk.Label(window, text="Password Length:", font=("Arial", 14), bg="#f5f5f5", fg="#333")
length_label.pack()
...
lowercase_check = tk.Checkbutton(window, text="Lowercase Letters", variable=lowercase_var, font=("Arial", 12), bg="#f5f5f5", fg="#333")
lowercase_check.pack()
lowercase_var.set(True)  # Default to including lowercase letters

uppercase_var = tk.BooleanVar()
uppercase_check = tk.Checkbutton(window, text="Uppercase Letters", variable=uppercase_var, font=("Arial", 12), bg="#f5f5f5", fg="#333")
uppercase_check.pack()

digits_var = tk.BooleanVar()
digits_check = tk.Checkbutton(window, text="Digits", variable=digits_var, font=("Arial", 12), bg="#f5f5f5", fg="#333")
digits_check.pack()

special_chars_var = tk.BooleanVar()
special_chars_check = tk.Checkbutton(window, text="Special Characters", variable=special_chars_var, font=("Arial", 12), bg="#f5f5f5", fg="#333")
special_chars_check.pack()

# Generate Password button
generate_button = tk.Button(window, text="Generate Password", command=generate_password_button_clicked, font=("Arial", 16), bg="#007acc", fg="white")
